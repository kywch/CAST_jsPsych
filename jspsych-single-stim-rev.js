...
jsPsych.plugins["single-stim-rev"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('single-stim-rev', 'stimulus', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var after_response = function(info) {
      ...
      // chagned from 'only record the first response'
      // to 'overide the current response with the new one'
      response = info;

      if (trial.response_ends_trial && can_finish) {
        end_trial();
      }
    };
